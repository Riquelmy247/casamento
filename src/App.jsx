  ...
  return (
    <div className="bg-page-pattern min-h-svh">
      ...
      <a
        ...
        className="fixed bottom-24 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-olive text-white shadow-xl ring-2 ring-white/80 transition hover:scale-105 hover:bg-olive-dark md:bottom-8 md:right-8"
